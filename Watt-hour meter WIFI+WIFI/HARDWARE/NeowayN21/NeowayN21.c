...
//鉴权信息
char ProductKey0[20]=	"a1TymkIzezE";
char DeviceName0[50]=	"h8rdware";
...
{
	u8 i;
	char three[100]={"AT+IMQTTAUTH="};
	u8 buf[250];
	i=0;
	
	three[13+i++]='\"';for(;*ProductKey;ProductKey++)three[13+i++]=*ProductKey;			three[13+i++]='\"';	three[13+i++]=',';
	three[13+i++]='\"';for(;*DeviceName;DeviceName++)three[13+i++]=*DeviceName;			three[13+i++]='\"';	three[13+i++]=',';
	three[13+i++]='\"';for(;*DeviceSecret;DeviceSecret++)three[13+i++]=*DeviceSecret;	three[13+i++]='\"';	three[13+i++]='\r';three[13+i++]='\n';
	do			//设备鉴权
	{
		i=0;
		printf_num=1;
