...
//设置任务优先级
#define ReadMeter_TASK_PRIO       		2 
//设置任务堆栈大小
#define ReadMeter_STK_SIZE  		    512
//任务堆栈	
__align(8)OS_STK ReadMeter_TASK_STK[ReadMeter_STK_SIZE];
//任务函数
void ReadMeter_task(void *pdata);
