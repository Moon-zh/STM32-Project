...
void NotifyText(uint16 screen_id, uint16 control_id, uint8 *str)
{
	...
	war=0;
	if(screen_id==2+sensor_num-1&&control_id==3)
	{
		Alarm_war[war].Alarm_airtemp_up=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==4)
	{
		Alarm_war[war].Alarm_airtemp_dn=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==5)
	{
		Alarm_war[war].Alarm_airhumi_up=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==6)
	{
		Alarm_war[war].Alarm_airhumi_dn=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==7)
	{
		Alarm_war[war].Alarm_light_up=value;
	}
	else if(screen_id==2+sensor_num-1&&control_id==8)
	{
		Alarm_war[war].Alarm_light_dn=value;
	}
	else if(screen_id==2+sensor_num-1&&control_id==9)
	{
		Alarm_war[war].Alarm_CO2_up=value;
	}
	else if(screen_id==2+sensor_num-1&&control_id==10)
	{
		Alarm_war[war].Alarm_CO2_dn=value;
	}
	else if(screen_id==2+sensor_num-1&&control_id==11)
	{
		Alarm_war[war].Alarm_soilhumi_up=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==12)
	{
		Alarm_war[war].Alarm_soilhumi_dn=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==13)
	{
		Alarm_war[war].Alarm_soiltemp_up=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==14)
	{
		Alarm_war[war].Alarm_soiltemp_dn=value*10;
	}
	else if(screen_id==2+sensor_num-1&&control_id==15)
	{
		Alarm_war[war].Alarm_EC_up=value;
	}
	else if(screen_id==2+sensor_num-1&&control_id==16)
	{
		Alarm_war[war].Alarm_EC_dn=value;
	}
	else if(screen_id==4+sensor_num-1&&control_id==1)
	{
		sprintf(ssid,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==2)
	{
		sprintf(password,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==3)
	{
		sprintf(ip,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==4)
	{
		sprintf(network,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==5)
	{
		sprintf(gateway,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==6)
	{
		sprintf(dns,"%s",str);
	}
	else if(screen_id==4+sensor_num-1&&control_id==9)
	{
		DHCP=value;
	}
	else if(screen_id==4+sensor_num-1&&control_id==30)
	{
		up_time=value;
	}
	else if(screen_id==4+sensor_num-1&&control_id==31)
	{
		up_wartime=value;
	}
}
