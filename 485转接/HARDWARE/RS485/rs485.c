...
void RS485_InitTXE(void)
{
...

    {
        ...
        GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12|GPIO_Pin_0;	 //PB5 PB14端口配置
        GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;		 //推挽输出
        GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
*********************************************************************************************************
*/
void RS485_4_SendOver(void)
{
    RS485_TX_EN4=0;	/* 切换RS485收发芯片为接收模式 */
}
...
static void UartVarInit(void)
{
    ...
    g_tUart1.SendBefor = RS485_3_SendBefor;						/* 发送数据前的回调函数 */
    g_tUart1.SendOver = RS485_3_SendOver;						/* 发送完毕后的回调函数 */
    ...
    g_tUart2.SendBefor = RS485_4_SendBefor;						/* 发送数据前的回调函数 */
    g_tUart2.SendOver = RS485_4_SendOver;						/* 发送完毕后的回调函数 */
