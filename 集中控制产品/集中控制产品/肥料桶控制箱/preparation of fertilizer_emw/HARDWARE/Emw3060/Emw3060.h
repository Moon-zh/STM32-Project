...
#define UPLOAD_LEVEL		01
#define UPLOAD_DIAMETER		02
#define UPLOAD_PERCENT		03
#define UPLOAD_UPPER		04
#define UPLOAD_LOWER		05
#define UPLOAD_STIRTIME		06
#define UPLOAD_WATERSWITCH	07
#define UPLOAD_STIRSWITCH	8
#define UPLOAD_COUNTDOWN	9
