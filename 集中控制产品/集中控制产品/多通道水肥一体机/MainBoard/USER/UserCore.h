...
#define MSG_CONTIUE     0X18    //任务继续
#define MSG_PAGEEND     0X19    //界面停止
...
//报警信息
#define FLOWER_ERROR       	1	 //水表数据错误
#define PRESS_BUTTON_ERROR  2	 //压力开关错误
#define TAGEND_ERROR		3	 // 终端错误
#define BOARD_COM_ERROR     4    //板间通信错误
typedef struct
{
	u8 CmdType;
	u8 CmdSrc;
