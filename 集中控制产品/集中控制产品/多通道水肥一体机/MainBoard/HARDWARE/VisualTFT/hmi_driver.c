...
void SetMulSerialText3(uint16 screen_id,uint16 control_id,uint8 Num,uint32* Data,uint8* u8data)
{
	uint8 i=0;
	SendBeginCMD();
	TX_8(0xB1);
...
void SetButtonValue1(uint16 screen_id,uint16 control_id,uint8 Num,uint8* Data)
{
	uint8 i=0;
	SendBeginCMD();
	TX_8(0xB1);
